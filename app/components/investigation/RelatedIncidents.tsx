      ...
      <div className="space-y-3">
        {incidents.map((inc) => (
          <div
            ...
            className="group flex flex-col sm:flex-row sm:items-center justify-between gap-3 rounded-2xl border border-slate-100 bg-slate-50/70 p-4 hover:border-emerald-300 hover:bg-emerald-50/40 transition-all cursor-pointer"
          >
            <div className="space-y-1">
              <div className="flex items-center gap-2">
                <span className="font-mono text-xs font-extrabold text-emerald-800 bg-emerald-100/80 px-2 py-0.5 rounded">
                  {inc.id}
                </span>
