      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        {cases.map((c) => (
          <Link
            ...
            className="group rounded-2xl border border-slate-200/80 bg-slate-50/50 p-4 transition-all hover:bg-white hover:border-blue-300 hover:shadow-md"
          >
            ...
            <div className="mt-3 flex items-center justify-between border-t border-slate-200/60 pt-2.5 text-[11px]">
