...
export const IntelErrorState: React.FC<Props> = ({ onRetry }) => {
  return (
    <div className="rounded-3xl border border-rose-200/80 bg-white p-10 md:p-12 text-center shadow-xs space-y-4">
      ...
      <div className="space-y-1">
        ...
        <p className="text-xs text-slate-500 max-w-md mx-auto">
          The threat telemetry query could not be completed. Please check your network connection or verify the indicator format.
        </p>
      </div>
